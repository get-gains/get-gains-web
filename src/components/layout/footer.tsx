...
export function Footer() {
  return (
    <footer className="bg-surface-0 border-border/50 border-t py-16">
        ...
        <div className="mb-16 grid gap-12 md:grid-cols-4">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-muted-foreground mb-6 max-w-sm leading-relaxed">
              The ultimate workout tracker with AI-powered form analysis.
              Perfect your technique, earn rewards, achieve your goals.
            </p>
            {/* Social Links */}
            <div className="flex items-center gap-4">
              {socialLinks.map((social) => (
                <a
                  key={social.name}
                  href="#"
                  className="bg-surface-2 group hover:bg-primary/20 flex h-10 w-10 items-center justify-center rounded-full transition-colors"
